...
def main():
    ...
    if(width > 2000):
        ...
        crop_image = rotate_image[(int)((height/2)-(int)((height/2)*0.2))-400:(int)(height/2)+(int)((height/2)*0.2)-200,(int)((width/2)) - (int)(width*0.4)+700:(int)(width/2) + (int)(width*0.4)-700]
    ...
    rect_kernel = cv2.getStructuringElement(cv2.MORPH_RECT, (4, 11))      #4 , 10
    ...
    cv2.imshow("2",  imgTesting )
    cv2.waitKey(0)

    rect_kernel1 = cv2.getStructuringElement(cv2.MORPH_RECT, (200, 50))      #4 , 10
...
def function(validContoursWithData, i, img, arrflag):
    ...
    # 루트 시작
    #temp = contourWithData
    #temp.intRectWidth = int(temp.intRectHeight * 0.5)
    ...
    if(function2(contourWithData,img)==308):
        ...
        imgROI_3 = img[contourWithData.intRectY + 10 : contourWithData.intRectY + contourWithData.intRectHeight ,    
                       contourWithData.intRectX + 56 : contourWithData.intRectX + contourWithData.intRectWidth ]
